...
The Whisper-style log-mel features the model takes as input are computed by
the vendored numpy-only code in the second half of this module.
"""
...
# ---------------------------------------------------------------------------
# Whisper-style log-mel feature extraction.
#
